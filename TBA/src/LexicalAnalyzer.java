...
public class LexicalAnalyzer {
    ...
    public static void main(String[] args) {
        ...
        /* Make a New Stack For Characters*/
        Stack validasi = new Stack();
        /* Make another Stack for Validation */
        ...
        while (i < length) {
            ...
            /* Token 6 (if) */ 
            else if (arrayChar[i] == 'i' && arrayChar[i + 1] == 'f' && (arrayChar[i + 2] == ' ' || arrayChar[i + 2] == 'p'
                    || arrayChar[i + 2] == 'q' || arrayChar[i + 2] == 'r' || arrayChar[i + 2] == 's' || arrayChar[i + 2] == '(')) {
                stack.push(arrayChar[i]);
                stack.push(arrayChar[i + 1]);
                System.out.print("6|");
                i = i + 2;
            ...
            /* Token 7 (then) */ 
            else if (arrayChar[i] == 't' && arrayChar[i + 1] == 'h' && arrayChar[i + 2] == 'e' && arrayChar[i + 3] == 'n'
                    && !stack.empty()) {
                stack.push(arrayChar[i]);
                stack.push(arrayChar[i + 1]);
                stack.push(arrayChar[i + 2]);
        ...
        while (!validasi.empty()) {
            try {
                ...
                if (validasi.peek().equals(temp) && (int) validasi.peek() != 10 && k != 0) {
                    System.out.print("NOT VALID\n");
                    break;
                } else if ((temp == 2 || temp == 6 || temp == 9 && validasi.peek().equals(1)) && k != 0) {
                    System.out.print("NOT VALID\n");
                    break;
                } else if (temp == 1 && validasi.peek().equals(1)) {
